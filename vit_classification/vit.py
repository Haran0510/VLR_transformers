...
class ViT(nn.Module):
    ...
    def patchify(self, images):
        ...
        # patches = patches.transpose(2, 3).contiguous().view(N, -1, self.patch_dim * self.patch_dim * C)

        patches = rearrange(images, 'n c (ph p1) (pw p2) -> n (ph pw) (p1 p2 c)', ph=4, pw=4, p1=self.patch_dim, p2=self.patch_dim)
